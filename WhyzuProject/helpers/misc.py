...
from WhyzuProject import LOGGER
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("WhyzuProject").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("WhyzuProject").info(f"Invalid Git Command")
        ...
        LOGGER("WhyzuProject").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("WhyzuProject").info(f"Heroku App Configured")
